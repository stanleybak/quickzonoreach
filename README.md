...
<p align="center"> <img src="code/quickzonoreach.png" alt="zono reach set" width=400/> <img src="code/hylaa.png" alt="Hylaa" width=350/> </p>
...
* `Zonotope.verts()`: get an approximate 2-d projection of the zonotope. This can be plotted directly with `Zonotope.plot()`.
